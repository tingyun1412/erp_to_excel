                ...
                if _tmpl_bytes:
                    ...
                    st.dataframe(
                        [{
                            ...
                            "訂單數量":  f"{itm.get('_total_qty','')}PCS",
                            "標籤數量":  f"{itm.get('_small_qty','')}PCS",
                            "裝箱（僅供參考，不影響標籤）": itm.get('_pack_qty','') or "",
                        ...
                        column_config={
                            ...
                            "訂單數量":  st.column_config.TextColumn(width="small"),
                            "標籤數量":  st.column_config.TextColumn(width="small"),
                            "裝箱（僅供參考，不影響標籤）": st.column_config.TextColumn(width="small"),
